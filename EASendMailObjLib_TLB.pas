...
// $Rev: 17244 $
// File generated on 2021/08/08 13:14:30 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll (1)
...
// Errors:
//   Error creating palette bitmap of (TMail) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TFastSender) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TCertificate) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TCertificateCollection) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TSimpleJsonParser) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TSimpleJsonArray) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TOAuthResponseParser) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TBrowserUi) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (THttpListener) : Server C:\Program Files (x86)\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
